            ...
            <div class="shopper-informations">
                <div class="row">
                    ...
                    <div class="col-sm-5 clearfix">
                        <div class="bill-to">
                            <p>Bill To</p>
                            <div class="form-one" style="margin: 10px 20px">

                                    <input type="text" class="form-control" style="margin-bottom: 10px" placeholder="Email*" name="email">
                                    <input type="text" class="form-control" style="margin-bottom: 10px" placeholder="Họ tên" name="name">
                                    <input type="text" class="form-control" style="margin-bottom: 10px" placeholder="Địa chỉ" name="address">
                                    <input type="text" class="form-control" style="margin-bottom: 10px" placeholder="Mobile Phone" name="phone">
                        ...
                        <td colspan="2">
                            <table class="table table-condensed total-result">
                                <tr>
                                    ...
                                    <td id="cart_total">{{number_format($total)." VND"}} </td>
                                </tr>
                                <tr>
                                    <td>Total Quantity</td>
                                    <td id="total_quantity">{{ isset($quantity) ? $quantity : 0 }}</td>
                                </tr>
                                ...
                                <tr>
                                    <td>Total</td>
                                    <td><span id="cart_total1">{{number_format($total)." VND"}}</span></td>
                                    <td>   <button type="submit" class="btn btn-primary">Đặt hàng</button>
                                        </td>
                                </tr>
