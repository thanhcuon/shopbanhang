...
@section('content')
    ...
    <div class="content-wrapper">
        @include('partials.content-header', ['name'=>'Posts','key'=>'Add'])
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name"  class="form-control"
                                       id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên bài viết">
                            </div>
                            <div class="mb-3">
                                <label  class="form-label " >Tóm Tắt</label>
                                <input type="text" name="title" class="form-control"
                                       id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập Tóm tắt">

                            </div>
                            <div class="mb-3">
                                <label  class="form-label">Hình ảnh bài viết</label>
                                <input type="file" name="image_path" class="form-control-file"
                                       id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="chọn hình ảnh bài viết">
                            </div>
                        </div>
                        <div class="col-md-12">
