                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-mb-3">
                                ...
                                <input type="text" value="{{$role->name}}" name="name" class="form-control"  id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên Slider">
                            ...
                            <div class="mb-12">
                                ...
                                <textarea type="text"
                                          ...
                                          style="height: 100px" >{{$role->display_name}}</textarea>
                            </div>
